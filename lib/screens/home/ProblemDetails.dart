...
class _ProblemDetailsState extends State<ProblemDetails> {
  ...
  Widget _buildLoadedDetails(Problem p) {
  ...
  gradeCell() {
    return Padding(
        ...
        child: Column(
            ...
            children: [
              Text(
                this.problem.gradename ?? "",
                style: TextStyle(
                    fontSize: this.fontSizeHuge, fontWeight: FontWeight.bold),
              ),
              Text(
                this.problem.tag ?? "",
                style: TextStyle(
                    fontSize: this.fontSizeTiny,
        ...
        child: Column(
            ...
            children: [
              Text(
                p.ascentcount ?? "",
                style: TextStyle(
                    fontSize: this.fontSizeLarge, fontWeight: FontWeight.bold),
              ),
              Text(
                "Global ascents",
                style: TextStyle(
  ...
  doLikeCell() {
    return Padding(padding: EdgeInsets.all(8.0), child: Text('Like'));
  }

  toolsCell() {
    return Padding(padding: EdgeInsets.all(8.0), child: Text('Tools'));
  }

  thumbsUbDownRow() {
    return Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: <Widget>[thumbsUp(), loves(), thumbsDown()]);
  }

  thumbsUp() {
    return Row(children: <Widget>[
      Text(this.problem.cLike ?? "", style: TextStyle(fontSize: 26)),
  ...
  loves() {
    return Row(children: <Widget>[
      Text(this.problem.cLove ?? "", style: TextStyle(fontSize: 26)),
      Icon(
  ...
  thumbsDown() {
    return Row(children: <Widget>[
      Text(this.problem.cDislike ?? "", style: TextStyle(fontSize: 26)),
